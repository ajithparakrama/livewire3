        ...
        <form class="space-y-6" wire:submit.prevent="register">
            <div>
                ...
                <input wire:model.lazy="email" id="email" name="email" type="email"  
                        class="@error('email') red @enderror block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div> 
                ...
                <input wire:model.lazy="password" id="password" name="password" type="password"  
                        class="@error('password') border-red-500 @enderror block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div> 
                ...
                <div class="mt-2">
                <input wire:model.lazy="passwordConfirmation" id="passwordConfirmation" name="password" type="password"  
...
{{-- <form wire:submit.prevent="register">
    ...
    <div><label for="passwordConfirmation">passwordConfirmation</label>
